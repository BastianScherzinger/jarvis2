...
_HERO_SCENES: dict[str, str] = {
    # ── Gesundheit & Beratung (zahnarzt/tierarzt VOR arzt!) ───────────────────────
    "zahnarzt":    "a bright modern dental practice treatment room, clean state-of-the-art equipment, a friendly dentist in fresh scrubs, calm reassuring atmosphere, soft daylight",
    "zahn":        "a pristine modern dental practice with clean equipment and warm welcoming light, calm professional healthcare mood",
    "kieferortho": "a modern orthodontic practice treatment room, clean bright equipment, friendly professional atmosphere",
    "physio":      "a bright modern physiotherapy practice, a therapist guiding a patient through an exercise on a treatment table, calm professional, natural light",
    "ergotherap":  "a calm modern occupational-therapy practice room with tidy equipment and warm natural light",
    "therapie":    "a calm modern therapy practice room with a treatment table and tidy equipment, soft natural light, reassuring atmosphere",
    "tierarzt":    "a friendly modern veterinary practice, a vet gently examining a calm pet, clean bright treatment room",
    "arzt":        "a bright modern medical practice, a friendly doctor in a clean consultation room, calm trustworthy healthcare atmosphere",
    "praxis":      "a bright modern medical practice reception and consultation area, calm professional, welcoming natural light",
    "apotheke":    "a clean modern pharmacy interior with tidy shelves and warm lighting, a friendly pharmacist, trustworthy",
    "rechtsanwalt":"an elegant modern law office with shelves of legal volumes, a confident lawyer at a clean desk, trustworthy professional mood, warm light",
    "anwalt":      "an elegant law office with legal books and a confident professional at a tidy desk, trustworthy atmosphere",
    "kanzlei":     "a refined modern law and consulting office in glass and wood, a professional reviewing documents, confident trustworthy mood",
    "notar":       "a dignified notary office with a tidy desk, documents and a fountain pen, warm trustworthy light",
    "steuerberat": "a professional tax-advisor office, tidy desk with documents, a laptop and a calculator, warm competent business atmosphere",
    "steuer":      "a tidy modern advisory office desk with financial documents and a laptop, warm professional light",
    "versicher":   "a modern insurance advisory office, a friendly advisor explaining a document to a client across a clean desk, trustworthy",
    "immobil":     "a bright modern German home exterior with manicured front garden at golden hour, premium and inviting, estate-agent quality",
    "makler":      "an elegant modern living room of a premium home staged for viewing, warm inviting light, real-estate photography",
    "architek":    "a bright architecture studio with a scale model, technical drawings and a designer at a clean desk, creative professional mood",
    "autohaus":    "a polished showroom of gleaming new cars in a bright modern car dealership, clean reflective floor, premium lighting",
    "fitness":     "a bright modern gym with clean equipment and motivational lighting, energetic premium atmosphere",
    "boden":       "a craftsman laying a flawless floor, a freshly finished gleaming wooden or stone surface in a bright modern room",
    "parkett":     "a freshly laid premium parquet floor gleaming under warm light in a bright modern room",
    "metzger":     "a clean traditional butcher counter with fresh quality cuts beautifully arranged, warm inviting light",
    # ── Bau & Handwerk ────────────────────────────────────────────────────────────

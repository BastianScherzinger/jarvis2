...
# Header/Get/Rating-Parser sind gemeinsam mit gelbe_seiten/dasoertliche/golocal.py — siehe
...
# Rating-Parser ist gemeinsam mit gelbe_seiten/dasoertliche/golocal.py — siehe scrapers/_http.py.

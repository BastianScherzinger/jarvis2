...
# Header/Get/Rating-Parser sind gemeinsam mit gelbe_seiten/elfacht/golocal.py — siehe
...
def _scrape_query(region, branche, on_lead, stop_event, max_per, BS4):
    ...
    for art in entries:
        ...
        if lead_id:
            ...
            try:
                logger.activity("DasOertliche", "Lead gefunden",
...
# Rating-Parser ist gemeinsam mit gelbe_seiten/elfacht/golocal.py — siehe scrapers/_http.py.
